...
class Net(nn.Module):
    def __init__(self):
        ...
        self.convblock_0 = nn.Sequential(
                       ...
                       nn.ReLU(),
                       nn.BatchNorm2d(16),
                      #  nn.Dropout(dropout_value), # Input - 32x32x3 | Output - 32X32X16 | RF=5

                       nn.Conv2d(in_channels=16,out_channels=32,kernel_size=(3,3),dilation=1,stride=1,padding=1,bias=False,),
                       nn.ReLU(),
                       nn.BatchNorm2d(32),
                      #  nn.Dropout(dropout_value), # Input - 32X32X16 | Output - 32X32x32 |RF=7

                       nn.Conv2d(in_channels=32,out_channels=64,kernel_size=(3,3),dilation=1,stride=1,padding=1,bias=False,),
                       nn.ReLU(),
                       nn.BatchNorm2d(64),
                       nn.Dropout(dropout_value), # Input - 32X32X32 | Output - 32X32X64 |RF= 9

                       nn.Conv2d(in_channels=64,out_channels=64,kernel_size=(3,3),dilation=1,stride=1,padding=1,bias=False,),
                       nn.ReLU(),
                       nn.BatchNorm2d(64),
                       nn.Dropout(dropout_value), # Input - 32X32X64 | Output - 32X32X64 |RF= 11
                      )
        ...
        self.convblock_2 = nn.Sequential(
                      ...
                      # pointwise   
                       ...
                       nn.Dropout(dropout_value + 0.1 + 0.1) 
        ...
        self.convblock_3 = nn.Sequential(
                      ...
                      #  # Input - 4X4X128 | Output - 4X4X64 | RF=85
                       ...
                       nn.ReLU(),
                       nn.BatchNorm2d(32),  
                       nn.Dropout(dropout_value + 0.1 + 0.1 + 0.1),  
